# PI-CI [![PI-CI](https://github.com/openoms/pi-ci/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/openoms/pi-ci/actions/workflows/main.yml)
